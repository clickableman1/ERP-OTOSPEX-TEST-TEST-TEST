...
class User_roleRepository extends BaseRepository implements User_roleRepositoryInterface
{
    public function __construct(User_role $model)
    {
    ...
    public function findAll($params) : array
    {
        ...
        if (isset($params['filter'])) {
            ...
            if (isset($filter['role_id'])) {
                $query->where('role_id', 'like', '%'.$filter['role_id'].'%');
            }
