...
class Role_permissionRepository extends BaseRepository implements Role_permissionRepositoryInterface
{
    public function __construct(Role_permission $model)
    {
    ...
    public function findAll($params) : array
    {
        ...
        if (isset($params['filter'])) {
            ...
            if (isset($filter['permission_id'])) {
                $query->where('permission_id', 'like', '%'.$filter['permission_id'].'%');
            }
...
,
                    'permission_id' => $attributes['permission_id'] ?? null
,
