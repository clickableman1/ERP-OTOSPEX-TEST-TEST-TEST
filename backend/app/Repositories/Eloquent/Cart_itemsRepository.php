...
class Cart_itemsRepository extends BaseRepository implements Cart_itemsRepositoryInterface
{
    public function __construct(Cart_items $model)
    {
