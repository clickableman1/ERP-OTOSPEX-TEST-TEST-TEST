...
warehousesStore.fetch()

/* Delete item */
const deleteItem = () => {
  warehousesStore.deleteItem(currentId.value)
}

const items = computed(() => warehousesStore.data)
  ...
  <table>
    ...
    <tbody>
      <tr
        ...
        :key="client.id"
        @click="$router.push(`/warehouses/${client.id}/edit`)"
      >
        <TableCheckboxCell
          v-if="checkable"
