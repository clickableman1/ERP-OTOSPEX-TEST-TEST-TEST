...
<template>
  ...
  <table>
    <thead>
      ...
      <th
        :class="['sortable uppercase text-sm font-normal text-pavitra-600', props.sortTitle === 'service_id' && props.sortDirection]"
        @click="sort('service_id')"
      >Service Id</th>
      ...
      <th
        :class="['sortable uppercase text-sm font-normal text-pavitra-600', props.sortTitle === 'appointment_date' && props.sortDirection]"
        @click="sort('appointment_date')"
      >Appointment Date</th>

      <th
        :class="['sortable uppercase text-sm font-normal text-pavitra-600', props.sortTitle === 'order_date' && props.sortDirection]"
      ...
      >
        ...
        />
              ...
              <td data-label="appointment_date">
                {{ dataFormatter.dateTimeFormatter(client.appointment_date) }}
              </td>    

              <td data-label="order_date">
                {{ dataFormatter.dateTimeFormatter(client.order_date) }}
              </td>    
