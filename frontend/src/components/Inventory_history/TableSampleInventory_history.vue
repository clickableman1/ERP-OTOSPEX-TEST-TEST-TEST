...
{ text: 'Quantity Change', value: 'quantity_change'},]
...
<template>
  ...
  <table>
    <thead>
      ...
      <th
        :class="['sortable uppercase text-sm font-normal text-pavitra-600', props.sortTitle === 'part_id' && props.sortDirection]"
        @click="sort('part_id')"
      >Part Id</th>

      <th
        :class="['sortable uppercase text-sm font-normal text-pavitra-600', props.sortTitle === 'transaction_type' && props.sortDirection]"
        @click="sort('transaction_type')"
      >Transaction Type</th>

      <th
        :class="['sortable uppercase text-sm font-normal text-pavitra-600', props.sortTitle === 'transaction_date' && props.sortDirection]"
        @click="sort('transaction_date')"
      >Transaction Date</th>

      <th
        :class="['sortable uppercase text-sm font-normal text-pavitra-600', props.sortTitle === 'quantity_change' && props.sortDirection]"
        @click="sort('quantity_change')"
      >Quantity Change</th>
    ...
    <tbody>
      ...
      >
        ...
        />
              ...
              <td data-label="quantity_change">
                {{ client.quantity_change }}
              </td>
