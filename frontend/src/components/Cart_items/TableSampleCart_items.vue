...
cart_itemsStore.fetch()

/* Delete item */
const deleteItem = () => {
  cart_itemsStore.deleteItem(currentId.value)
}

const items = computed(() => cart_itemsStore.data)
  ...
  <table>
    ...
    <tbody>
      <tr
        ...
        :key="client.id"
        @click="$router.push(`/cart_items/${client.id}/edit`)"
      >
        <TableCheckboxCell
          v-if="checkable"
