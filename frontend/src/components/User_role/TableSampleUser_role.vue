...
user_roleStore.fetch()

/* Delete item */
const deleteItem = () => {
  user_roleStore.deleteItem(currentId.value)
}

const items = computed(() => user_roleStore.data)
  ...
  <table>
    ...
    <tbody>
      <tr
        ...
        :key="client.id"
        @click="$router.push(`/user_role/${client.id}/edit`)"
      >
        <TableCheckboxCell
          v-if="checkable"
