...
<template>
  ...
  <table>
    <thead>
      ...
      <th
        :class="['sortable uppercase text-sm font-normal text-pavitra-600', props.sortTitle === 'language_id' && props.sortDirection]"
        @click="sort('language_id')"
      >Language Id</th>

      <th
        :class="['sortable uppercase text-sm font-normal text-pavitra-600', props.sortTitle === 'currency' && props.sortDirection]"
        @click="sort('currency')"
      >Currency</th>
