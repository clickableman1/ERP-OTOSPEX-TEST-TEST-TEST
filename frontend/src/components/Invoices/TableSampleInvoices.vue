...
<template>
  ...
  <table>
    <thead>
      ...
      <th
        :class="['sortable uppercase text-sm font-normal text-pavitra-600', props.sortTitle === 'invoice_number' && props.sortDirection]"
        @click="sort('invoice_number')"
      >Invoice Number</th>

      <th
        :class="['sortable uppercase text-sm font-normal text-pavitra-600', props.sortTitle === 'issue_date' && props.sortDirection]"
        @click="sort('issue_date')"
      >Issue Date</th>
      ...
      <th
        :class="['sortable uppercase text-sm font-normal text-pavitra-600', props.sortTitle === 'total_amount' && props.sortDirection]"
