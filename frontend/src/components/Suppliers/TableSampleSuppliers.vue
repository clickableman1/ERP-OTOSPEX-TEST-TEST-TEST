...
{ text: 'Year Established', value: 'year_established'},
...
<template>
  ...
  <table>
    <thead>
      ...
      <th
        :class="['sortable uppercase text-sm font-normal text-pavitra-600', props.sortTitle === 'country_of_origin' && props.sortDirection]"
        @click="sort('country_of_origin')"
      ...
      <th
        :class="['sortable uppercase text-sm font-normal text-pavitra-600', props.sortTitle === 'year_established' && props.sortDirection]"
        @click="sort('year_established')"
      >Year Established</th>
    ...
    <tbody>
      ...
      >
        ...
        />
              ...
              <td data-label="country_of_origin">
              ...
              <td data-label="year_established">
                {{ client.year_established }}
              </td>
