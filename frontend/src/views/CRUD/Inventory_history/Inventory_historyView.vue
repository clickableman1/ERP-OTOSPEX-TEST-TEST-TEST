...
const filters = ref([]);
const filtersList = [{label: 'Part Id', title: 'part_id'},{label: 'Transaction Type', title: 'transaction_type'},{label: 'Transaction Date', title: 'transaction_date'},{label: 'Quantity Change', title: 'quantity_change'},
