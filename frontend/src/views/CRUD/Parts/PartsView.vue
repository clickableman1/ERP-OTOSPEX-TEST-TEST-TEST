...
const filters = ref([]);
const filtersList = [{label: 'Name', title: 'name'},{label: 'Description', title: 'description'},{label: 'Barcode', title: 'barcode'},{label: 'Category', title: 'category'},{label: 'Dimensions', title: 'dimensions'},{label: 'Manufacturer Id', title: 'manufacturer_id'},{label: 'Supplier Id', title: 'supplier_id'},
          {label: 'Quantity In Stock', title: 'quantity_in_stock', number: 'true'},{label: 'Minimum Stock Level', title: 'minimum_stock_level', number: 'true'},
          {label: 'Price', title: 'price', number: 'true'},{label: 'Weight', title: 'weight', number: 'true'},
          ];
