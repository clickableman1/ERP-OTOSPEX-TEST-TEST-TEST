...
const filters = ref([]);
const filtersList = [{label: 'Name', title: 'name'},{label: 'Location', title: 'location'},{label: 'Email', title: 'email'},{label: 'Country Of Origin', title: 'country_of_origin'},{label: 'Phone', title: 'phone'},{label: 'Website', title: 'website'},
          {label: 'Year Established', title: 'year_established', number: 'true'},
