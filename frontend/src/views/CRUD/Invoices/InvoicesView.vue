...
const filters = ref([]);
const filtersList = [{label: 'Issue Date', title: 'issue_date'},{label: 'Due Date', title: 'due_date'},{label: 'User Id', title: 'user_id'},{label: 'Supplier Id', title: 'supplier_id'},

          {label: 'Invoice Number', title: 'invoice_number', number: 'true'},{label: 'Total Amount', title: 'total_amount', number: 'true'},
          ];
